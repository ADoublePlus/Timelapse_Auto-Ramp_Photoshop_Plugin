...
/*
    This utilities class stores functions responsible for reading/writing data from files, finding/replacing values, and displaying relevant information.
 */
public class Util {
    ...
    public String replace(File file, String key, double replace) {
        ...
        // Gets location of end of replace, remainder of file
