...
/*
    All changes need to store similar data.
    This class is used as the main object to store any setting change between images.
    Other objects inherit this class, adding data, such as exposure change, temperature change, etc.
 */
public class Change {
    Util util = new Util();
